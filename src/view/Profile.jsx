...
const Profile = () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://10.120.32.81/restaurant/api/v1/users/${userId}`,
        {
          method: 'PUT',
  ...
  return (
      <div className="profile-container">
        ...
        <div className="list">
          <ul>
            <li><strong>Nimi:</strong> {user.name}</li> {/* Display name */}
            <li><strong>Sähköposti:</strong> {user.email}</li> {/* Display email */}
            <li><strong>Puhelinnumero:</strong> {user.phone_number || 'N/A'}</li> {/* Display phone */}
          </ul>
