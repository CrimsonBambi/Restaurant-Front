...
test.describe('MenuPage', () => {
  test.beforeEach(async ({page}) => {
    await page.goto('https://localhost:5173/menu');
  });
  ...
  test('should open menu modal when clicking on a menu item', async ({
    page,
  }) => {
  ...
  test('should highlight the menu of the day', async ({page}) => {
    const highlightedMenu = await page.locator(
      '.menu-item-container.highlighted'
    );
